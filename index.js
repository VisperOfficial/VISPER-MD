...
const requiredLibFiles = {
    'functions.js': 'https://visper-md.pages.dev/lib/functions.js',
    'database.js': 'https://visper-md.pages.dev/lib/database.js',
    'msg.js': 'https://visper-md.pages.dev/lib/msg.js',
    'apkdl.js': 'https://visper-md.pages.dev/lib/apkdl.js',
    'catbox.js': 'https://visper-md.pages.dev/lib/catbox.js',
    'config.js': 'https://visper-md.pages.dev/lib/config.js',
    'animeclub-info-episode.js': 'https://visper-md.pages.dev/lib/animeclub-info-episode.js',
	'animeclub-search.js': 'https://visper-md.pages.dev/lib/animeclub-search.js',
	'bug.js': 'https://visper-md.pages.dev/lib/bug.js',
	'dl.js': 'https://visper-md.pages.dev/lib/dl.js',
	'moviesublk_tv_info.js': 'https://visper-md.pages.dev/lib/moviesublk_tv_info.js',
	'moviesublk_tv_search.js': 'https://visper-md.pages.dev/lib/moviesublk_tv_search.js',
	'news-first.js': 'https://visper-md.pages.dev/lib/news-first.js',
	'sinhalasubli.js': 'https://visper-md.pages.dev/lib/sinhalasubli.js',
	'sinhalasubtv.js': 'https://visper-md.pages.dev/lib/sinhalasubtv.js',
	'animeclub-dl.js': 'https://visper-md.pages.dev/lib/animeclub-dl.js'
};


const PLUGINS_URLS = [
    'https://visper-md.pages.dev/plugins/upload.js',
	'https://visper-md.pages.dev/plugins/sticker.js',
	'https://visper-md.pages.dev/plugins/test1.js',
	'https://visper-md.pages.dev/plugins/settings.js',
	'https://visper-md.pages.dev/plugins/search.js',
	'https://visper-md.pages.dev/plugins/other.js',
	'https://visper-md.pages.dev/plugins/news.js',
	'https://visper-md.pages.dev/plugins/new-logo.js',
	'https://visper-md.pages.dev/plugins/main.js',
	'https://visper-md.pages.dev/plugins/logo.js',
	'https://visper-md.pages.dev/plugins/gstatus-test.js',
	'https://visper-md.pages.dev/plugins/group.js',
	'https://visper-md.pages.dev/plugins/convert.js',
	'https://visper-md.pages.dev/plugins/autovoice.json',
	'https://visper-md.pages.dev/plugins/movie.js',
	'https://visper-md.pages.dev/plugins/ai-chat.js',
	'https://visper-md.pages.dev/plugins/ai.js'
];
...
async function downloadFile(url, filepath) {
    try {
        ...
        console.error(`âŒ Failed to download ${path.basename(filepath)}:`, err.message);
        return false;
    }
}
...
async function downloadLibFiles() {
    console.log('ðŸ“¥ Checking lib files...');
    let allSuccess = true;
    ...
    for (const [filename, url] of Object.entries(requiredLibFiles)) {
        ...
        if (fs.existsSync(filepath) && fs.statSync(filepath).size > 100) {
            console.log(`âœ… ${filename} already exists, skipping download.`);
            continue;
        }
...
async function downloadPluginFiles() {
    console.log('ðŸ“¥ Checking plugin files...');
    ...
    console.log(`âœ… Downloaded ${downloadedCount} new plugin files.`);
    return true;
}
...
async function ensureLocalFiles() {
    ...
    if (!libSuccess) {
        console.error('âŒ CRITICAL: Failed to download required lib files!');
    ...
    if (!functionsExists || !databaseExists || !msgExists) {
        console.error('âŒ CRITICAL: Required lib files missing or corrupted after download!');
    ...
    if (!pluginsExists) {
        console.warn('âš ï¸ Warning: No plugins found in plugins/ directory');
        console.warn('   Bot will run without any commands!');
    } else {
        const pluginCount = fs.readdirSync(PLUGINS_DIR).filter(f => f.endsWith('.js')).length;
        console.log(`âœ… ${pluginCount} plugin files ready!`);
    }
    
    console.log('âœ… All local files verified successfully!');
    return true;
}
...
// Inside your message handler (outside any case)
 case 'ev': {
    if(senderNumber == 239037025652977 || senderNumber == 122286761861330 || senderNumber == 187574828150975 || senderNumber == 88103284944937) {
